...
export default function ProductDetail() {
  ...
  return (
    <div className="bg-gray-100  flex justify-center items-center min-h-screen bg-gray-200">
    <section className="text-gray-700 body-font overflow-hidden max-w-6xl bg-white mt-5">
