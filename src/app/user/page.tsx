...
const generateUser = ():User => ({
  ...
  const UserProfilePage = async ({ params }: { params: { id: string } }) => {
    const user = generateUser(); // Lấy dữ liệu người dùng
    ...
    return  (
        <div className="flex justify-center items-center min-h-screen bg-gray-200">
            <form className="relative mt-10 mb-10 mx-auto w-full max-w-3xl bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:rounded-xl sm:px-10">
